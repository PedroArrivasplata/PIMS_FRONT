    ...
    if (!empty($correo) && !empty($clave)) {
        ...
        if ($httpCode === 200) {
            ...
            if ($usuario['tipo_usuario'] === 'recepcionista') {
                header('Location: ../assets/oficial.html');
                exit;
            } elseif ($usuario['tipo_usuario'] === 'veterinario') {
                header('Location: ../assets/1_inicio.php');
                exit;
            } else {
                header('Location: ../assets/oficial.php');
                exit;
            }
        } else {
...
<?php endif; ?>
  ...
  <div class="login-wrapper d-flex justify-content-center align-items-center">
    ...
    <main class="login-container animate__animated animate__fadeInDown mx-3">
      ...
      <p class="text-center">
        ¿No tienes cuenta? <a href="../assets/registrar_nuevo_usuario.php" class="text-primary">Regístrate aquí</a>
